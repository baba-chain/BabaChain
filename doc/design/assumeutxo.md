...
Assumeutxo is a feature that allows fast bootstrapping of a validating babachaind
...
considered active. This is the "traditional" mode of operation for babachaind.
...
**Failure consideration:** if babachaind unexpectedly halts after `m_stop_use` is set on
...
### BabaChaind restarts sometime after snapshot validation has completed

When babachaind initializes again, what began as the snapshot chainstate is now
