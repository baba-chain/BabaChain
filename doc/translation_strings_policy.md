...
This document provides guidelines for internationalization of the BabaChain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `babachain_en.ts` remains unchanged.
