...
This guide describes how to build babachaind, command-line utilities, and GUI on NetBSD.

**This guide has not been tested for building BabaChain Core and may fail. Please report your results; contributions welcome.**
...
It is not necessary to build wallet functionality to run babachaind or the GUI.
...
BabaChain Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure BabaChain Core. Here is an example that
