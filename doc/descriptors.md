# Support for Output Descriptors in BabaChain Core

Since BabaChain Core v0.17, there is support for Output Descriptors. This is a
...
existing BabaChain Core wallets, a convenience function `combo` is
...
All RPCs in BabaChain Core will include the checksum in their output. Only
