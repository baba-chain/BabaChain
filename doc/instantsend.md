...
This mechanism has been integrated into Bitcore-Node-BabaChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/babachainpay/insight-api-babachain#web-socket-api](https://github.com/babachainpay/insight-api-babachain#web-socket-api)
* API: [https://github.com/babachainpay/insight-api-babachain#instantsend-transactions](https://github.com/babachainpay/insight-api-babachain#instantsend-transactions)
