        ...
        Task {
            ...
            do {
                for i in 0...retries {
                    ...
                    let babachainNumber = Decimal(result.totalBalance)
...
extension CrowdNode {
        ...
        Task {
            ...
            if account.transactionIsValid(confirmationTx) {
                do {
                    ...
                    let forwarded = try await sendCoinsService.sendCoins(address: CrowdNode.crowdNodeAddress, amount: CrowdNode.apiConfirmationBabaChainAmount,
    ...
    private func getApiAddressConfirmationTx() -> DSTransaction? {
        let filter = CoinsToAddressTxFilter(coins: CrowdNode.apiConfirmationBabaChainAmount, address: nil) // account address is unknown at this point
