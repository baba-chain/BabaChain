...
extension CrowdNode {
    ...
    static let minimumRequiredBabaChain: UInt64 = 1_000_000
    static let requiredForSignup = minimumRequiredBabaChain - 100_000
    static let requiredForAcceptTerms: UInt64 = 100_000
    static let apiOffset: UInt64 = 20000
    static let minimumDeposit = UInt64(kOneBabaChain / 2)
    static let minimumLeftoverBalance: UInt64 = 30_000
    static let apiConfirmationBabaChainAmount: UInt64 = 54321
    ...
    static let howToVerifyUrl = "https://knowledge.crowdnode.io/en/articles/6114502-how-to-confirm-your-api-babachain-address"
}
