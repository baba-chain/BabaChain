...
final class CrowdNodeAPIConfirmationTx: CoinsToAddressTxFilter {
    ...
    init(primaryAddress: String, apiAddress: String) {
        super.init(coins: CrowdNode.apiConfirmationBabaChainAmount, address: apiAddress)
...
final class CrowdNodeAPIConfirmationTxForwarded: CoinsToAddressTxFilter {
    init() {
        super.init(coins: CrowdNode.apiConfirmationBabaChainAmount, address: CrowdNode.crowdNodeAddress, withFee: true)
    }
}
