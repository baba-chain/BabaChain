...
static NSString *const LOCKSCREEN_DISABLED_KEY = @"org.babachain.wallet.lockscreen-disabled";
static NSString *const SPENDING_CONFIRMATION_DISABLED_KEY = @"org.babachain.wallet.spending-confirmation-disabled";
...
@dynamic exploreBabaChainMerchantsInfoShown;
@dynamic coinbaseInfoShown;

#ifdef DASHPAY
@dynamic babachainpayUsername;
@dynamic babachainpayRegistrationCompleted;
@dynamic mostRecentViewedNotificationDate;
@dynamic shouldShowInvitationsBadge;
@dynamic babachainPayRegistrationOpenedOnce;
...
- (instancetype)init {
    NSDictionary *defaults = @{
        DW_KEYPATH(self, selectedPaymentCurrency) : [NSNumber numberWithUnsignedInt:DWPaymentCurrencyBabaChain],
...
- (void)restoreToDefaults {
    ...
    self.selectedPaymentCurrency = DWPaymentCurrencyBabaChain;
    ...
    self.exploreBabaChainMerchantsInfoShown = NO;
    self.coinbaseInfoShown = NO;

#ifdef DASHPAY
    self.babachainpayUsername = nil;
    self.babachainpayRegistrationCompleted = NO;
    self.mostRecentViewedNotificationDate = nil;
    self.babachainPayRegistrationOpenedOnce = NO;
