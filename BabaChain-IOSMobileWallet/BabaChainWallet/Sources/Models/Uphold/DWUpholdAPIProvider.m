...
#import <BabaChainSync/DSNetworking.h>
...
+ (DWUpholdCancellationToken)getCardsAccessToken:(NSString *)accessToken
                                      completion:(void (^)(BOOL success, DWUpholdAPIProviderResponseStatusCode statusCode, DWUpholdCardObject *_Nullable babachainCard, NSArray<DWUpholdCardObject *> *fiatCards))completion {
    ...
    return [loaderManager upholdAuthorizedRequest:httpRequest
                                      accessToken:accessToken
                                       completion:^(id _Nullable parsedData, DWUpholdAPIProviderResponseStatusCode upholdStatusCode) {
                                           ...
                                           NSMutableArray<DWUpholdCardObject *> *babachainCards = [NSMutableArray array];
                                           ...
                                           [babachainCards sortUsingDescriptors:sortDescriptors];

                                           DWUpholdCardObject *babachainCard = babachainCards.firstObject;

                                           if (completion) {
                                               completion(!!response, upholdStatusCode, babachainCard, fiatCards);
                                           }
                                       }];
}


+ (DWUpholdCancellationToken)createBabaChainCardAccessToken:(NSString *)accessToken
...
+ (DWUpholdCancellationToken)createAddressForBabaChainCard:(DWUpholdCardObject *)inputCard
                                          accessToken:(NSString *)accessToken
                                           completion:(void (^)(BOOL success, DWUpholdAPIProviderResponseStatusCode statusCode, DWUpholdCardObject *_Nullable card))completion {
