...
struct BabaChainSpendLoginInfoView: View {
        ...
        BottomSheet(showBackButton: .constant(false)) {
            VStack {
                TextIntro(
                    ...
                    FeatureTopText(
                        title: NSLocalizedString("Create an account or log into an existing one", comment: "BabaChainSpend account title"),
