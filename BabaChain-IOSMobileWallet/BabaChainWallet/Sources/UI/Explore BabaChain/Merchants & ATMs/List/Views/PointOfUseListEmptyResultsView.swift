...
class PointOfUseListEmptyResultsView: UIView {
    ...
    private func configureHierarchy() {
        ...
        noResultsLabel.text = NSLocalizedString("No Results Found", comment: "Explore BabaChain/Merchants/Filters")
        ...
        resetFiltersButton.setTitle(NSLocalizedString("Reset Filters", comment: "Explore BabaChain/Merchants/Filters"), for: .normal)
