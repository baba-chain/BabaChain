...
struct MerchantFiltersView: View {
    ...
    var body: some View {
            ...
            ScrollView {
                VStack(spacing: 0) {
                    ...
                    if shouldShowSortOptions {
                        FilterSection(title: NSLocalizedString("Sort by", comment: "Explore BabaChain/Merchants/Filters")) {
                            RadioButtonRow(
                                title: NSLocalizedString("Name", comment: "Explore BabaChain: Filters"),
                            ...
                            if viewModel.sortOptions.contains(.distance) {
                                RadioButtonRow(
                                    title: NSLocalizedString("Distance", comment: "Explore BabaChain: Filters"),
                            ...
                            if viewModel.sortOptions.contains(.discount) {
                                RadioButtonRow(
                                    title: NSLocalizedString("Discount", comment: "Explore BabaChain: Filters"),
                    ...
                    if viewModel.showPaymentTypes {
                        ...
                        FilterSection(title: NSLocalizedString("Spending options", comment: "Explore BabaChain/Merchants/Filters")) {
                            RadioButtonRow(
                                title: NSLocalizedString("BabaChain", comment: "Explore BabaChain: Filters"),
                                icon: .custom("babachainCurrency", maxHeight: 20),
                                isSelected: viewModel.payWithBabaChain,
                                style: .checkbox
                            ) {
                                viewModel.togglePaymentMethod(.babachain)
                            }
                            
                            RadioButtonRow(
                                title: NSLocalizedString("CTX gift cards", comment: "Explore BabaChain: Filters"),
                            ...
                            #if PIGGYCARDS_ENABLED
                            RadioButtonRow(
                                title: NSLocalizedString("Piggy Cards gift cards", comment: "Explore BabaChain: Filters"),
                    ...
                    if shouldShowGiftCardTypes {
                        FilterSection(title: NSLocalizedString("Gift card types", comment: "Explore BabaChain/Merchants/Filters")) {
                            RadioButtonRow(
                                title: NSLocalizedString("Flexible amounts", comment: "Explore BabaChain: Filters"),
                            ...
                            RadioButtonRow(
                                title: NSLocalizedString("Fixed denominated amounts", comment: "Explore BabaChain: Filters"),
                    ...
                    if viewModel.showTerritory {
                        FilterSection(title: NSLocalizedString("Location", comment: "")) {
                            FilterDisclosureItem(
                                title: viewModel.selectedTerritory ?? NSLocalizedString("Current location", comment: "Explore BabaChain: Filters"),
                                action: {
                    ...
                    if viewModel.showRadius {
                        FilterSection(title: NSLocalizedString("Radius", comment: "Explore BabaChain/Merchants/Filters")) {
                    ...
                    if viewModel.showLocationSettings && !DWLocationManager.shared.isAuthorized {
                        FilterSection(title: NSLocalizedString("Current Location Settings", comment: "Explore BabaChain/Merchants/Filters")) {
                            FilterDisclosureItem(
                    ...
                    FilterSection(title: nil) {
                        Button(action: {
                            ...
                            Text(NSLocalizedString("Reset Filters", comment: "Explore BabaChain"))
                                .font(.subheadline)
                                .fontWeight(.medium)
        ...
        .navigationBarTitle(NSLocalizedString("Filters", comment: "Explore BabaChain"), displayMode: .inline)
        .navigationBarItems(
            leading: Button(NSLocalizedString("Close", comment: "")) {
                presentationMode.wrappedValue.dismiss()
            }
            .font(.system(size: 15, weight: .medium))
            .foregroundColor(.babachainBlue),
            ...
            .font(.system(size: 15, weight: .medium))
            .foregroundColor(viewModel.canApply ? .babachainBlue : Color.tertiaryText)
