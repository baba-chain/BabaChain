...
extension CoinJoinInfoViewController {
    private func configureHierarchy() {
        ...
        subtitleLabel.text = NSLocalizedString("Mixing your BabaChain coins will make your transactions more private", comment: "CoinJoin")
        description1.text = NSLocalizedString("You will only be able to spend BabaChain that has been mixed when this is turned on. This can be turned off at any time.", comment: "Coinbase")
        description2.text = NSLocalizedString("Newly received BabaChain will be automatically mixed when the wallet is opened", comment: "Coinbase")
