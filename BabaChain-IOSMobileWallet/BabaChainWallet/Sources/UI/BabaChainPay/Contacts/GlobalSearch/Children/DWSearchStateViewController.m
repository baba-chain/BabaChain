...
- (UIButton *)actionButton {
    if (_actionButton == nil) {
        DWBabaChainButton *button = [[DWBabaChainButton alloc] init];
...
- (void)configurePlaceholderState {
    ...
    NSAttributedString *subtitle =
        [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Find a user on the BabaChain Network", nil)
...
- (void)configureSearchingAnimationState {
    ...
    NSString *format = NSLocalizedString(@"Searching for username %@ on the BabaChain Network", nil);
...
- (void)configureActionButtonForSearchUsers {
    ...
    [self.actionButton setTitle:NSLocalizedString(@"Search for a User on the BabaChain Network", nil)
