    ...
    public var body: some View {
        ZStack(alignment: .bottom) {
            VStack(alignment: .leading) {
                ...
                HStack(spacing: 0) {
                    let text = String.localizedStringWithFormat(NSLocalizedString("Please vote to approve my requested BabaChain username - %@", comment: "Usernames"), viewModel.username)
