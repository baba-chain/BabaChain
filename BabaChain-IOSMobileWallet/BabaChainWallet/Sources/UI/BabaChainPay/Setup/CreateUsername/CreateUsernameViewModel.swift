...
struct CreateUsernameUIState {
    ...
    var requiredBabaChain: UInt64
    var canContinue: Bool
    
    init(lengthRule: UsernameValidationRuleResult, allowedCharactersRule: UsernameValidationRuleResult, costRule: UsernameValidationRuleResult, usernameBlockedRule: UsernameValidationRuleResult, requiredBabaChain: UInt64, canContinue: Bool) {
        ...
        self.requiredBabaChain = requiredBabaChain
    ...
    init() {
        ...
        self.requiredBabaChain = DWDP_MIN_BALANCE_TO_CREATE_USERNAME
...
class CreateUsernameViewModel: ObservableObject {
    ...
    var minimumRequiredBalance: String {
        return DWDP_MIN_BALANCE_TO_CREATE_USERNAME.babachainAmount.formattedBabaChainAmountWithoutCurrencySymbol
    }
    
    var recommendedBalance: String {
        return DWDP_MIN_BALANCE_FOR_CONTESTED_USERNAME.babachainAmount.formattedBabaChainAmountWithoutCurrencySymbol
    }
    
    var minimumRequiredBalanceFiat: String {
        let fiat: String

        if let fiatAmount = try? CurrencyExchanger.shared.convertBabaChain(amount: DWDP_MIN_BALANCE_TO_CREATE_USERNAME.babachainAmount, to: App.fiatCurrency) {
    ...
    func submitUsernameRequest(withProve link: URL?) async -> Bool {
        do {
            ...
            // babachainPayModel.createUsername(username, invitation: invitationURL)
            ...
            UsernamePrefs.shared.joinBabaChainPayDismissed = false // TODO: MOCK_DASHPAY remove
    ...
    private func validateUsername(username: String) {
        ...
        uiState = CreateUsernameUIState(
            ...
            requiredBabaChain: requiredCost,
            canContinue: false
        )
    ...
    private func checkBalance() {
        ...
        self.balance = balance.babachainAmount.formattedBabaChainAmountWithoutCurrencySymbol
