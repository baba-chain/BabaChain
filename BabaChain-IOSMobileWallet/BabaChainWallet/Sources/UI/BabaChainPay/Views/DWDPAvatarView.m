...
#import "DWUIKit.h"
#import "UIColor+DWBabaChainPay.h"
...
NSString *const DPCropParameterName = @"babachainpay-profile-pic-zoom";
...
- (void)setUsername:(NSString *)username {
    ...
    if (username.length >= 1) {
        ...
        self.layer.backgroundColor = [UIColor dw_babachainBlueColor].CGColor;
    }
}

- (void)setAsBabaChainPlaceholder {
    ...
    self.imageView.image = [UIImage imageNamed:@"icon_babachain_small"];
}
...
- (void)updateBackgroundColor {
    ...
    switch (self.backgroundMode) {
        case DWDPAvatarBackgroundMode_BabaChainBlue:
            color = [UIColor dw_babachainBlueColor];
            break;
