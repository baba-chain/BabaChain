...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        view.backgroundColor = [UIColor dw_babachainNavigationBlueColor];
        ...
        titleLabel.text = NSLocalizedString(@"Invite your friends and family to the BabaChain Network", nil);
