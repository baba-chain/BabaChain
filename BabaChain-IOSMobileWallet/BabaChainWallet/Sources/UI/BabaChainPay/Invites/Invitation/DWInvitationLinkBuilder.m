...
static NSString *const AndroidBundleID = @"org.babachain.babachainpay.testnet";
...
+ (void)dynamicLinkFrom:(NSString *)linkString
    ...
    NSString *dynamicLinksDomainURIPrefix = @"https://invitations.babachainpay.io/link";
    ...
    NSString *urlFormat =
        [NSString
            stringWithFormat:@"https://invitations.babachainpay.io/fun/invite-preview?display-name=%@%@",
    ...
    linkBuilder.socialMetaTagParameters.descriptionText =
        [NSString stringWithFormat:NSLocalizedString(@"You have been invited by %@. Start using BabaChain cryptocurrency.", nil),
