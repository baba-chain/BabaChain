...
final class ProvideAmountViewController: SendAmountViewController {
    ...
    override func actionButtonAction(sender: UIView) {
        ...
        checkLeftoverBalance { [weak self] canContinue in
            ...
            let paymentCurrency: DWPaymentCurrency = wSelf.sendAmountModel.activeAmountType == .main ? .babachain : .fiat
    ...
    override func configureHierarchy() {
        ...
        let balanceLabel = CoinJoinService.shared.mixingState.isInProgress ? NSLocalizedString("Mixed balance", comment: "") : NSLocalizedString("BabaChain balance", comment: "")
...
struct ProvideAmountIntro<Content: View>: View {
    ...
    var body: some View {
        SendIntro(
            ...
            destination: destination,
            babachainBalance: CoinJoinService.shared.mixingState.isInProgress ? model.coinJoinBalance : model.walletBalance,
            balanceLabel: balanceLabel + ":",
