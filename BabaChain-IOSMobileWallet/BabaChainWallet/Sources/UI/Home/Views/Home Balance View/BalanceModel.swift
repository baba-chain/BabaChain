...
extension BalanceModel: BalanceViewDataSource {
    var mainAmountString: String {
        value.formattedBabaChainAmount
    }
...
extension BalanceModel {
    func babachainAmountStringWithFont(_ font: UIFont, tintColor: UIColor) -> NSAttributedString {
        NSAttributedString.babachainAttributedString(for: value, tintColor: tintColor, font: font)
    }

    func fiatAmountString() -> String {
        CurrencyExchanger.shared.fiatAmountString(for: value.babachainAmount)
    }
}
