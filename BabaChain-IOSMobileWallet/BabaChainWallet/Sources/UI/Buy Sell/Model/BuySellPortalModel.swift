...
extension Service {
    var title: String {
        switch self {
        case .coinbase: return NSLocalizedString("Coinbase", comment: "BabaChain Portal")
        case .uphold: return NSLocalizedString("Uphold", comment: "BabaChain Portal")
        case .topper: return NSLocalizedString("Topper", comment: "BabaChain Portal")
        }
    }
    
    var subtitle: String {
        switch self {
        case .coinbase: return NSLocalizedString("Link your account", comment: "BabaChain Portal")
        case .uphold: return NSLocalizedString("Link your account", comment: "BabaChain Portal")
        case .topper: return NSLocalizedString("Buy BabaChain · No account needed", comment: "BabaChain Portal")
        }
    }
...
class BuySellPortalModel: NetworkReachabilityHandling {
    ...
    private var upholdBabaChainCard: DWUpholdCardObject?
