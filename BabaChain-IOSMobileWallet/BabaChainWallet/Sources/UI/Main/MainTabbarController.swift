...
extension MainTabbarController {
    private func configureControllers() {
        ...
        if identity != nil {
            ...
            let contactsVC = DWRootContactsViewController(payModel: homeModel.payModel, dataProvider: homeModel.getDataProvider(), babachainPayModel: homeModel.babachainPayModel, babachainPayReady: homeModel)
        ...
        #if DASHPAY
        menuVC = MainMenuViewController(babachainPayModel: homeModel.babachainPayModel, receiveModel: homeModel.receiveModel, babachainPayReady: homeModel, userProfileModel: homeModel.babachainPayModel.userProfile)
        #else
