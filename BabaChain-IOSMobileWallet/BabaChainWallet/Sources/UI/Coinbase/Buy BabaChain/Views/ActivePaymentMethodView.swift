...
final class ActivePaymentMethodView: UIView {
    ...
    public func update(with paymentMethod: CoinbasePaymentMethod?) {
        guard let paymentMethod else {
            paymentMethodTitleLabel.text = NSLocalizedString("No payment methods", comment: "Coinbase/Buy BabaChain")
    ...
    private func configureHierarchy() {
        ...
        titleLabel.text = NSLocalizedString("Pay with", comment: "Coinbase/Buy BabaChain")
