...
enum ConvertCryptoOrderItem: PreviewOrderItem {
    ...
    var localizedDescription: String? {
        ...
        case .destination:
            return NSLocalizedString("to BabaChain Wallet on this device", comment: "Coinbase")
        default:
            return nil
        }
    }
...
extension ConvertCryptoOrderPreviewController {
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .origin, .destination:
            let account = item == .origin ? convertCryptoOrderPreviewModel.selectedAccount : convertCryptoOrderPreviewModel.babachainAccount
