...
final class TransferAmountViewController: CoinbaseAmountViewController, ConverterViewDelegate {
    ...
    override func configureHierarchy() {
        ...
        navigationItem.title = NSLocalizedString("Transfer BabaChain", comment: "Coinbase")
...
extension TransferAmountViewController {
    ...
    private func showSuccessTransactionStatus() {
        showSuccessTransactionStatus(text: NSLocalizedString("It could take up to 10 minutes to transfer BabaChain from Coinbase to BabaChain Wallet on this device", comment: "Coinbase"))
    }
}
