...
- (uint64_t)babachainAmount {
    return self.stubBabaChainAmount;
}
...
+ (NSArray<DWTransactionStub *> *)stubs {
...

    {
        ...
        tx.stubBabaChainAmount = DUFFS * 3.140000000001;
...

    {
        ...
        tx.stubBabaChainAmount = DUFFS * 2.710000000001;
...

    {
        ...
        tx.stubBabaChainAmount = DUFFS * 1.6180000000001;
        tx.stubDirection = DSTransactionDirection_Sent;
        [stubs addObject:tx];
    }

    {
        ...
        tx.stubBabaChainAmount = DUFFS * 44.0480000000001;
        tx.stubDirection = DSTransactionDirection_Received;
        [stubs addObject:tx];
    }
