...
struct ZenLedgerInfoSheet: View {
        ...
        BottomSheet(showBackButton: Binding<Bool>.constant(false)) {
            TextIntro(
                ...
                FeatureTopText(
                    ...
                    text: NSLocalizedString("Connect your crypto wallets to the ZenLedger platform. Learn more and get started with your BabaChain Wallet transactions.", comment: "ZenLedger"),
                    label: "zenledger.io",
    ...
    private func resolveAlert() -> Alert {
        if errorAlert {
            ...
            Alert(
                title: Text(NSLocalizedString("Allow sending all transactions from BabaChain Wallet to Zenledger?", comment: "ZenLedger")),
