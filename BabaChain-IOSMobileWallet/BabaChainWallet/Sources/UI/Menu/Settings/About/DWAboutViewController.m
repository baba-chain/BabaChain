...
#import "DWUIKit.h"
#import "DWWindow.h"
#import "SFSafariViewController+BabaChainWallet.h"
...
@property (strong, nonatomic) IBOutlet UIImageView *babachainLogoImageView;
@property (strong, nonatomic) IBOutlet UILabel *appVersionLabel;
@property (strong, nonatomic) IBOutlet UILabel *babachainSyncVersionLabel;
@property (strong, nonatomic) IBOutlet UILabel *descriptionLabel;

@property (strong, nonatomic) IBOutlet UILabel *exploreBabaChainLastDeviceSyncLabel;
@property (strong, nonatomic) IBOutlet UILabel *exploreBabaChainLastServerUpdateLabel;
...
- (void)viewDidLoad {
    ...
    self.babachainLogoImageView.tintColor = [UIColor dw_babachainBlueColor];
    self.appVersionLabel.font = [UIFont dw_fontForTextStyle:UIFontTextStyleTitle3];
    self.babachainSyncVersionLabel.font = [UIFont dw_fontForTextStyle:UIFontTextStyleFootnote];
    ...
    self.babachainSyncVersionLabel.text = [self.model babachainSyncVersion];
    ...
    [self.repositoryURLButton setTitle:@"https://github.com/babachainpay/babachainwallet-ios" forState:UIControlStateNormal];
    ...
    self.copyrightLabel.text = NSLocalizedString(@"Copyright © 2023 BabaChain Core", nil);
    self.exploreBabaChainLastDeviceSyncLabel.text = [self.model exploreBabaChainSyncState];
    self.exploreBabaChainLastServerUpdateLabel.text = [self.model exploreLastServerUpdateDate];
...
- (IBAction)respositoryURLAction:(id)sender {
    NSURL *url = [NSURL URLWithString:@"https://github.com/babachainpay/babachainwallet-ios?files=1"];
...
- (void)exploreBabaChainDatabaseSyncStateChanged {
    self.exploreBabaChainLastDeviceSyncLabel.text = [self.model exploreBabaChainSyncState];
    self.exploreBabaChainLastServerUpdateLabel.text = [self.model exploreLastServerUpdateDate];
}
