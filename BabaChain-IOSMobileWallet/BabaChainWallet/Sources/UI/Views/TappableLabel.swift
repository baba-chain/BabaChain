    ...
    public func setAction(for text: String, action: @escaping TappableLabelAction) {
        ...
        mutableAttributedString
            .addAttributes([
                ...
                NSAttributedString.Key.foregroundColor: UIColor.dw_babachainBlue(),
                NSAttributedString.Key.backgroundColor: UIColor.dw_babachainBlue().withAlphaComponent(0.08),
            ],
            range: range)
