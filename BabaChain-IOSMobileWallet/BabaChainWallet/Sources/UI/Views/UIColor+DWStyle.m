...
+ (UIColor *)dw_babachainBlueColor {
    UIColor *color = [UIColor colorNamed:@"BabaChainBlueColor"];
    NSParameterAssert(color);
    return color;
}

+ (UIColor *)dw_babachainNavigationBlueColor {
    UIColor *color = [UIColor colorNamed:@"BabaChainNavigationBarBlueColor"];
    NSParameterAssert(color);
    return color;
}
