...
final class OnlineAccountDetailsController: BaseViewController {
    ...
    private func configureHierarchy() {
        ...
        subtitleLabel.text = NSLocalizedString("Your primary BabaChain address that you currently use for your CrowdNode account", comment: "CrowdNode")
        primaryAddressTitle.text = NSLocalizedString("Primary BabaChain address", comment: "CrowdNode")
        subtitle2Label.text = NSLocalizedString("BabaChain address designated for your CrowdNode account in the BabaChain Wallet on this device ", comment: "CrowdNode")
        addressTitle.text = NSLocalizedString("BabaChain address", comment: "")
    }
}
