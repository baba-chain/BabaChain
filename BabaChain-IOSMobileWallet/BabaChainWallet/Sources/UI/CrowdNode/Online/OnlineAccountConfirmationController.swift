...
final class OnlineAccountConfirmationController: BaseViewController {
    ...
    private var paymentRequest: DSPaymentRequest {
        ...
        paymentRequest.amount = CrowdNode.apiConfirmationBabaChainAmount
...
extension OnlineAccountConfirmationController {
    private func configureHierarchy() {
        ...
        titleLabel.text = NSLocalizedString("Verify your API BabaChain address", comment: "CrowdNode")
        howToConfirmLabel.text = NSLocalizedString("How to confirm your API BabaChain address", comment: "CrowdNode")
        primaryAddressTitle.text = NSLocalizedString("Primary BabaChain address", comment: "CrowdNode")
        info2Label.text = NSLocalizedString("to the BabaChain address designated for your CrowdNode account in the BabaChain Wallet on this device", comment: "CrowdNode")
        primaryAddressLabel.text = viewModel.primaryAddress
        addressTitle.text = NSLocalizedString("BabaChain address", comment: "CrowdNode")
        ...
        attentionLabel.text = NSLocalizedString("We will automatically detect this transaction and transfer the same amount to your CrowdNode account. After that you will be able to make deposits and withdrawals in BabaChain Wallet on this device.", comment: "CrowdNode")
        
        let confirmationAmount = CrowdNode.apiConfirmationBabaChainAmount.formattedBabaChainAmount
        infoLabel.text = String
            .localizedStringWithFormat(NSLocalizedString("Send %@ from your primary BabaChain address that you currently use for your CrowdNode account", comment: "CrowdNode Confirm"),
                                       confirmationAmount)
