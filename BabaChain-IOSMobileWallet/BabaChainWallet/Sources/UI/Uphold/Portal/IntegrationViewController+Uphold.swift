...
extension IntegrationViewController: DWUpholdLogoutTutorialViewControllerDelegate {
    ...
    private func createUpholdTransferController() -> UIViewController? {
        ...
        guard let babachainCard = (self.model as? UpholdPortalModel)?.babachainCard else { return nil }
        
        let controller = UpholdTransferViewController.init(card: babachainCard)
