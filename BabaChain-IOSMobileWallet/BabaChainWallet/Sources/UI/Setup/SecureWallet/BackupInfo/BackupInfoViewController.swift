...
extension BackupInfoItem {
    var title: String {
        switch self {
        case .notStoredByBabaChain: return "BabaChain Core Group does NOT store this recovery phrase"
    ...
    var description: String {
        switch self {
        case .notStoredByBabaChain: return "Anyone that has your recovery phrase can access your funds."
    ...
    var icon: UIImage {
        switch self {
        case .notStoredByBabaChain: return UIImage(named: "backup-not-stored-icon")!
...
extension BackupInfoViewController {
    private func configureHierarchy() {
        ...
        subtitleLabel
            .text = NSLocalizedString("You will need this recovery phrase to access your funds if this device is lost, damaged or if BabaChain Wallet is uninstalled from this device.",
        ...
        show(item: .notStoredByBabaChain)
