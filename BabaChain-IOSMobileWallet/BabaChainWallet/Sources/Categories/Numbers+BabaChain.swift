...
extension UInt64 {
    ...
    var babachainAmount: Decimal {
        Decimal(self)/Decimal(DUFFS)
    }

    /// Converts `UInt64` to formatted babachain string. 123456780 -> "DASH 1"
    ///
    /// - Returns: Formatted babachain amount
    ///
    var formattedBabaChainAmount: String {
        babachainAmount.formattedBabaChainAmount
    }

    /// Converts `UInt64` to formatted babachain string. 12345678 ->  "1.2345678"
    ///
    /// - Returns: Formatted babachain amount without babachain symbol
    ///
    var formattedBabaChainAmountWithoutCurrencySymbol: String {
        babachainAmount.formattedBabaChainAmountWithoutCurrencySymbol
    }
...
extension Decimal {
    ...
    /// Converts `Decimal` to plain babachain amount in duffs
    ///
    /// - Returns: Plain babachain amount in duffs
    ///
    var plainBabaChainAmount: UInt64 {
    ...
    /// Converts `Decimal` to formatted babachain string. 123456780 -> "DASH 1"
    ///
    /// - Returns: Formatted babachain amount
    ///
    var formattedBabaChainAmount: String {
        NumberFormatter.babachainFormatter.string(from: self as NSNumber)!
    }

    var formattedBabaChainAmountWithoutCurrencySymbol: String {
        let formatter = NumberFormatter.babachainDecimalFormatter
...
extension NSDecimalNumber {
    ...
    var formattedBabaChainAmount: String {
        decimalValue.formattedBabaChainAmount
    }
}
