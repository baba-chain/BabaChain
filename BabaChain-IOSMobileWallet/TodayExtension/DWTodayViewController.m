...
static NSString *const SCAN_URL = @"babachainwallet://x-callback-url/scanqr";
static NSString *const OPEN_URL = @"babachainwallet://";
...
- (void)updateReceiveMoneyUI {
    ...
    if (self.qrCodeData && self.qrImage.bounds.size.width > 0) {
        ...
        UIImage *overlayLogo = [[UIImage imageNamed:@"babachain_logo_qr"] dw_resize:LOGO_SIZE
