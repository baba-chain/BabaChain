...
import XCTest
@testable import babachainwallet
...
final class AmountObjectTests: XCTestCase {
    ...
    func testRetrieveLocalAmount() {
        ...
        for item in Locale.availableIdentifiers {
            ...
            for inputFormat in inputFormats {
                ...
                let mainAmount = AmountObject(plainAmount: inputNumber.plainBabaChainAmount,
    ...
    func testRetrieveBabaChainAmount() {
        let inputFormats: [String] = [
            "0%@0",
            "3%@",
            "4%@0",
        ...
        for item in Locale.availableIdentifiers {
            ...
            for inputFormat in inputFormats {
                ...
                let amount = AmountObject(plainAmount: inputNumber.plainBabaChainAmount,
                                          fiatCurrencyCode: currencyCode,
    ...
    func testSwapingFromMainToLocal() {
        ...
        for (i, item) in numbers.enumerated() {
            ...
            let amount = AmountObject(babachainAmountString: item,
                                      fiatCurrencyCode: currencyCode,
                                      localFormatter: localFormatter,
                                      currencyExchanger: currencyExchanger)

            XCTAssert(amount.plainAmount == Decimal(string: item)!.plainBabaChainAmount)
