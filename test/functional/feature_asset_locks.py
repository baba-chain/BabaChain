...
# Copyright (c) 2022-2025 The BabaChain Core developers
...
class AssetLocksTest(BabaChainTestFramework):
    def set_test_params(self):
        self.set_babachain_test_params(2, 0, [[
                "-whitelist=127.0.0.1",
    ...
    # does not cause any issues in BabaChain Core
