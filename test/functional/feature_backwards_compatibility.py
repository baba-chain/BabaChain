...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # it expected to fail with error 'DBErrors::TOO_NEW' but BabaChain Core can open v18 by version 17
        # can be implemented in future if there's any incompatible versions
        #node_v17.assert_start_raises_init_error(["-wallet=w3_v18"], "Error: Error loading w3_v18: Wallet requires newer version of BabaChain Core")
        #node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of BabaChain Core")
        ...
        # Bitcoin creates hd wallets by default since v16, but BabaChain Core v17 does not.
