...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]    # node used to mine BABACHAIN and create transactions
        ...
        # generate some BABACHAIN to create transactions and check blockcount
        ...
        # send 10 BABACHAIN to user's first watch-only address
        self.log.info('Send 10 BABACHAIN to user')
        ...
        # send 5 BABACHAIN to our second watch-only address
        self.log.info('Send 5 BABACHAIN to user')
        ...
        # send 1 BABACHAIN to our third watch-only address
        self.log.info('Send 1 BABACHAIN to user')
