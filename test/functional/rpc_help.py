...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: BabaChain's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'BabaChain', 'Evo', 'Mining', 'Network', 'Rawtransactions', 'Util']
