...
"""Verify that starting babachaind with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start babachaind with -h for help text")
        ...
        self.log.info("Start babachaind with -version for version information")
        ...
        self.log.info("Start babachaindd with -fakearg to make sure it does not start")
