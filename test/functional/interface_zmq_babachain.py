...
"""Test the babachain specific ZMQ notification interfaces."""
...
class BabaChainZMQTest (BabaChainTestFramework):
    def set_test_params(self):
        self.set_babachain_test_params(5, 4)
        ...
        self.set_babachain_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that babachaind has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all babachain related ZMQ publisher
