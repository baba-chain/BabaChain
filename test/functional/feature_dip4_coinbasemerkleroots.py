#!/usr/bin/env python3
# Copyright (c) 2015-2025 The BabaChain Core developers
...
class LLMQCoinbaseCommitmentsTest(BabaChainTestFramework):
    def set_test_params(self):
        ...
        self.set_babachain_test_params(4, 3, extra_args = self.extra_args)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BabaChainTestFramework doesn't support this atm)
