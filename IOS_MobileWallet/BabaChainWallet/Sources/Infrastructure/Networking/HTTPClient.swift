...
private let apiWorkQueue = DispatchQueue(label: "org.babachainfoundation.babachain.queue.api",
                                         attributes: .concurrent)
private let eTagReaderQueue = DispatchQueue(label: "org.babachainfoundation.babachain.queue.api.etag",
                                            target: apiWorkQueue)
