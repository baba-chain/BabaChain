...
let kExploreBabaChainDatabaseName = "explore.db"
...
class ExploreDatabaseConnection {
    ...
    private func dbPath() -> String? {
        let downloadedPath = FileManager.documentsDirectoryURL.appendingPathComponent(kExploreBabaChainDatabaseName).path
