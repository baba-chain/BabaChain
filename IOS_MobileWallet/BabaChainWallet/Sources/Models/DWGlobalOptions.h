...
@property (nonatomic, assign) BOOL exploreBabaChainMerchantsInfoShown;
@property (nonatomic, assign) BOOL coinbaseInfoShown;

#ifdef DASHPAY
@property (nonatomic, assign) BOOL babachainPayRegistrationOpenedOnce;
@property (nonatomic, assign) BOOL babachainpayRegistrationCompleted;
...
@property (nullable, nonatomic, copy) NSString *babachainpayUsername;
