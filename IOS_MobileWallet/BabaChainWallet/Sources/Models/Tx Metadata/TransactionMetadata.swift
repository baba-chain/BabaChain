...
extension TransactionMetadata {
    ...
    func fiatAmountString(from babachainAmount: UInt64) -> String {
        ...
        if let rate,
           ...
           let rateMaximumFractionDigits {
            ...
            let fiatAmount = try? CurrencyExchanger.shared.convertBabaChain(amount: babachainAmount.babachainAmount,
                                                                       to: rateCurrency,
                                                                       rate: rate)
