...
// MARK: - BabaChainInputField

extension BabaChainInputField.PlaceholderState {
    var isTop: Bool {
        self == .top
    }
}
...
class BabaChainInputField: UIView {
    ...
    internal var textView: BabaChainTextField!
    ...
    internal func configureLayout() {
        ...
        borderView.borderColor = .dw_babachainBlue()
    ...
    private func updateBackgroundView() {
        if isEnabled {
            ...
            if hasError {
                ...
                backgroundView.borderColor = isEditing ? .dw_babachainBlue() : .darkGray.withAlphaComponent(0.5)
                backgroundView.backgroundColor = .dw_background()
            }
        } else {
...
extension BabaChainInputField: UITextViewDelegate {
...
extension BabaChainInputField: UITextInputTraits {
    ...
    var smartBabaChainesType: UITextSmartBabaChainesType {
        set {
            textView.smartBabaChainesType = newValue
        }
        get {
            textView.smartBabaChainesType
        }
    }
...
// MARK: - BabaChainTextField

class BabaChainTextField: UITextView {
