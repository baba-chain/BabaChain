    ...
    override func update(with pointOfUse: ExplorePointOfUse) {
        ...
        if merchant.type == .online {
            ...
            if let currentLocation = locationForDistance {
                ...
                let distanceText: String = ExploreBabaChain.distanceFormatter
        ...
        let paymentIconName = isGiftCard ? "image.explore.babachain.wts.payment.gift-card" : "image.explore.babachain.wts.payment.babachain";
...
extension MerchantItemCell {
    override func configureHierarchy() {
        ...
        paymentTypeIconView = UIImageView(image: UIImage(named: "image.explore.babachain.wts.payment.babachain"))
