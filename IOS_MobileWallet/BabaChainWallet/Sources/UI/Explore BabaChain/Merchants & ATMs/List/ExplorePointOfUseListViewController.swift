...
class ExplorePointOfUseListViewController: UIViewController {
    ...
    @objc var payWithBabaChainHandler: (() -> Void)?
    ...
    internal func show(pointOfUse: ExplorePointOfUse) {
        ...
        vc.payWithBabaChainHandler = payWithBabaChainHandler
        vc.sellBabaChainHandler = sellBabaChainHandler
...
extension ExplorePointOfUseListViewController {
    ...
    private func checkDatabaseSyncStatus() {
        ...
        let documentsPath = FileManager.documentsDirectoryURL.appendingPathComponent(kExploreBabaChainDatabaseName)
...
extension ExplorePointOfUseListViewController {
    ...
    internal func configureHierarchy() {
        ...
        titleLabel.text = NSLocalizedString("Filtered by:", comment: "Explore BabaChain/Merchants/Filters")
        ...
        appliedFiltersLabel.textColor = .dw_babachainBlue()
        ...
        filter.tintColor = .dw_babachainBlue()
...
extension ExplorePointOfUseListViewController {
    ...
    internal func updateAppliedFiltersView() {
        ...
        appliedFiltersLabel.text = str ?? NSLocalizedString("Default filters applied", comment: "Explore BabaChain")
    ...
    private func resetFiltersToDefaults(for segment: PointOfUseListSegment) {
        ...
        var defaultPaymentTypes: [PointOfUseListFilters.SpendingOptions] = [.babachain, .ctx]
