...
struct BabaChainSpendTermsScreen: View {
    ...
    var body: some View {
        ZStack {
            VStack(spacing: 0) {
                ...
                TextIntro(
                    icon: .custom("babachainspend.logo", maxHeight: 32),
                    inProgress: Binding.constant(false)
                ) {
                    FeatureTopText(
                        title: NSLocalizedString("Accept terms and\nconditions", comment: "BabaChainSpend"),
