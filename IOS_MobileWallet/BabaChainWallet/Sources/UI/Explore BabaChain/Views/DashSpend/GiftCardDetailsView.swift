        ...
        ScrollView {
            VStack(spacing: 0) {
                ...
                HStack(spacing: 15) {
                    ZStack(alignment: .bottomTrailing) {
                        if let icon = viewModel.uiState.merchantIcon {
                            ...
                            Image("image.explore.babachain.wts.payment.gift-card")
                                .resizable()
                                .scaledToFit()
                                .frame(width: 48, height: 48)
                        }
                ...
                VStack(spacing: 0) {
                    ...
                    if let barcodeImage = viewModel.uiState.barcodeImage {
                        ...
                        ZStack {
                            ...
                            if viewModel.uiState.isLoadingCardDetails {
                                ...
                                Text(NSLocalizedString("Failed to load barcode", comment: "BabaChainSpend"))
                                    .font(.footnote)
                                    .foregroundColor(.systemRed)
                            } else {
                                Text(NSLocalizedString("Barcode placeholder", comment: "BabaChainSpend"))
                                    .font(.caption)
                                    .foregroundColor(.tertiaryText)
                            }
                        }
                    ...
                    HStack {
                        Text(NSLocalizedString("Original purchase", comment: "BabaChainSpend"))
                            .font(.subheadline)
                            .fontWeight(.medium)
                            .foregroundColor(.tertiaryText)
                    ...
                    if let merchantUrl = viewModel.uiState.merchantUrl {
                        Button(action: {
                            ...
                            Text(NSLocalizedString("Check current balance", comment: "BabaChainSpend"))
                                .font(.footnote)
                                .fontWeight(.medium)
                    ...
                    if viewModel.uiState.isLoadingCardDetails {
                        ...
                        VStack(spacing: 15) {
                            ...
                            if let cardNumber = viewModel.uiState.cardNumber {
                                HStack {
                                    Text(NSLocalizedString("Card number", comment: "BabaChainSpend"))
                                        .font(.subheadline)
                                        .fontWeight(.medium)
                                        .foregroundColor(.tertiaryText)
                            ...
                            if let cardPin = viewModel.uiState.cardPin {
                                HStack {
                                    Text(NSLocalizedString("Card PIN", comment: "BabaChainSpend"))
                                        .font(.subheadline)
                                        .fontWeight(.medium)
                                        .foregroundColor(.tertiaryText)
                ...
                Button(action: {
                    ...
                    HStack {
                        Text(NSLocalizedString("View transaction details", comment: "BabaChainSpend"))
                            .font(.subheadline)
                            .fontWeight(.medium)
                            .foregroundColor(.primaryText)
                ...
                if !showHowToUse {
                    Button(action: {
                        ...
                        Text(NSLocalizedString("See how to use this gift card", comment: "BabaChainSpend"))
                            .font(.subtitle1)
                            .foregroundColor(.babachainBlue)
                    }
                    .padding(.top, 30)
                    ...
                    VStack(alignment: .leading, spacing: 30) {
                        Text(NSLocalizedString("How to use your gift card", comment: "BabaChainSpend"))
                            .font(.body2)
                            .fontWeight(.medium)
                            .foregroundColor(.tertiaryText)
                        ...
                        FeatureSingleItem(
                            ...
                            title: NSLocalizedString("Self-checkout", comment: "BabaChainSpend"),
                            description: NSLocalizedString("Request assistance and show the barcode on your screen for scanning.", comment: "BabaChainSpend")
                        )
                        
                        // In store
                        FeatureSingleItem(
                            iconName: .custom("image.babachainspend.shop"),
                            title: NSLocalizedString("In store", comment: "BabaChainSpend"),
                            description: NSLocalizedString("Tell the cashier that you'd like to pay with a gift card and share the card number and pin.", comment: "BabaChainSpend")
                        )
                        
                        // Online
                        FeatureSingleItem(
                            iconName: .custom("image.babachainspend.online"),
                            title: NSLocalizedString("Online", comment: "BabaChainSpend"),
                            description: NSLocalizedString("In the payment section of your checkout, select \"gift card\" and enter your card number and pin.", comment: "BabaChainSpend")
                        )
                    }
                    .padding(.horizontal, 15)
                    .padding(.bottom, 35)
                ...
                // Powered by CTX
                VStack(spacing: 8) {
                    Text(NSLocalizedString("Powered by", comment: "BabaChainSpend"))
                        .font(.callout)
                        .foregroundColor(.tertiaryText)
