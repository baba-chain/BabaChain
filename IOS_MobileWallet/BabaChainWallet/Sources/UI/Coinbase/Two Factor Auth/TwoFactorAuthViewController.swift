...
final class TwoFactorAuthViewController: ActionButtonViewController {
    ...
    func styleContactCoinbase() {
        ...
        let contactCoinbasnAttributedLinkString = NSMutableAttributedString(string: contactCoinbaseString,
                                                                            attributes: [
                                                                                .foregroundColor: UIColor.dw_babachainBlue(),
    ...
    func styleTwoFactorAuthFieldDefaultState() {
        ...
        twoFactorAuthField.layer.borderColor = UIColor.dw_babachainBlue().cgColor
...
extension TwoFactorAuthViewController: NavigationStackControllable {
    func shouldPopViewController() -> Bool {
        if isCancelingToFail {
            let title = NSLocalizedString("Are you sure you want to cancel this transaction?", comment: "Coinbase/Buy BabaChain/Cancel Order")
            let message = NSLocalizedString("Canceling this transaction does not cancel the trade order. You will receive DASH on your Coinbase account shortly.",
                                            comment: "Coinbase/Buy BabaChain/Cancel Order")
