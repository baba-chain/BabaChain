...
class OrderPreviewViewController: BaseViewController, NetworkReachabilityHandling {
    ...
    @objc
    func cancelAction() {
        let alert = UIAlertController(title: nil, message: NSLocalizedString("Are you sure you want to cancel this order?", comment: "Coinbase/Buy BabaChain/Cancel Order"), preferredStyle: .alert)
    ...
    func feeInfoAction() {
        ...
        vc.headerText = NSLocalizedString("Fees in crypto purchases", comment: "Coinbase/Buy BabaChain/Fee Info")
        vc.descriptionText = NSLocalizedString("""
            ...
            """, comment: "Coinbase/Buy BabaChain/Fee Info")
...
extension OrderPreviewViewController {
    ...
    private func updateActionButton() {
        ...
        let title = String(format: NSLocalizedString("Confirm (%d%@)", comment: "Coinbase/Buy BabaChain/Confirm Order"), timeRemaining,
...
extension OrderPreviewViewController {
    ...
    internal func configureModel() {
        ...
        model.failureHandle = { [weak self] _ in
            self?
                .showFailedTransactionStatus(text: NSLocalizedString("The BabaChain was successfully deposited to your Coinbase account. But there was a problem transfering it to BabaChain Wallet on this device.",
    ...
    internal func configureHierarchy() {
        title = NSLocalizedString("Order Preview", comment: "Coinbase/Buy BabaChain/Confirm Order")
        ...
        actionButton.setTitle(NSLocalizedString("Confirm", comment: "Coinbase/Buy BabaChain/Confirm Order"), for: .normal)
