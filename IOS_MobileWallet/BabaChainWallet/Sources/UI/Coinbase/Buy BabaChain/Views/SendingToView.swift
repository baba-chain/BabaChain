...
final class SendingToView: UIView {
    ...
    private func configureHierarchy() {
        ...
        titleLabel.text = NSLocalizedString("Sending to:", comment: "Buy BabaChain")
        ...
        let babachainIcon = UIImageView(image: UIImage(named: "babachainCircleFilled"))
        destinationStackView.addArrangedSubview(babachainIcon)

        let destinationLabel = UILabel()
        destinationLabel.translatesAutoresizingMaskIntoConstraints = false
        destinationLabel.textColor = .dw_label()
        destinationLabel.font = .dw_font(forTextStyle: .footnote)
        destinationLabel.text = NSLocalizedString("BabaChain Wallet on this device", comment: "Buy BabaChain")
        ...
        NSLayoutConstraint.activate([
            ...
            babachainIcon.widthAnchor.constraint(equalToConstant: 18),
            babachainIcon.heightAnchor.constraint(equalToConstant: 18),
        ])
    }
}
