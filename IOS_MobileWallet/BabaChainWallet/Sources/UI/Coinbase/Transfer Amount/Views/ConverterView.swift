...
enum ConverterViewDirection {
    ...
    private var fromSource: Source {
        self == .fromWallet ? .babachain : .coinbase
    }

    private var toSource: Source {
        self == .fromWallet ? .coinbase : .babachain
    }
...
struct ConverterViewSourceItem: SourceViewDataProvider {
    ...
    static func babachain(subtitle: String? = nil, balanceFormatted: String = "", fiatBalanceFormatted: String = "") -> ConverterViewSourceItem {
        ConverterViewSourceItem(image: .asset("image.explore.babachain.wts.babachain"),
                                title: "BabaChain",
                                subtitle: subtitle,
...
private enum Source {
    ...
    var imageName: String {
        switch self {
        case .babachain: return "image.explore.babachain.wts.babachain"
    ...
    var title: String {
        switch self {
        case .babachain: return kWalletName
        case .coinbase: return "Coinbase"
        }
    }
}
