...
extern NSNotificationName const DWBabaChainPayRegistrationStatusUpdatedNotification;
extern NSNotificationName const DWBabaChainPaySentContactRequestToInviter;

@class DWDPRegistrationStatus;
@class DSBlockchainIdentity;
@class DWCurrentUserProfileModel;

@protocol DWBabaChainPayProtocol <NSObject>
