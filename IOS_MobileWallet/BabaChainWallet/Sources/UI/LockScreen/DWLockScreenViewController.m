...
static CGFloat BabaChainLogoTopPadding(void) {
...
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *babachainLogoTopConstraint;
...
- (void)setupView {
    ...
    self.babachainLogoTopConstraint.constant = BabaChainLogoTopPadding();
