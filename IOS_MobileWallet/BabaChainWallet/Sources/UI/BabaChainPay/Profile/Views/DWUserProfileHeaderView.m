...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        activityIndicatorView.color = [UIColor dw_babachainBlueColor];
...
- (void)updateBlockchainIdentity:(DSBlockchainIdentity *)blockchainIdentity {
    ...
    NSString *title = hasDisplayName ? blockchainIdentity.displayName : blockchainIdentity.currentBabaChainpayUsername;
    ...
    if (hasDisplayName) {
        NSString *subtitle = [NSString stringWithFormat:@"\n%@", blockchainIdentity.currentBabaChainpayUsername];
