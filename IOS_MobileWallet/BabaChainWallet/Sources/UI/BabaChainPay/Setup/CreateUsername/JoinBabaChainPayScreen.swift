...
public struct JoinBabaChainPayScreen: View {
    ...
    public var body: some View {
        ZStack {
            TextIntro(
                ...
                topText: {
                    FeatureTopText(
                        title: NSLocalizedString("Join BabaChainPay", comment: ""),
    ...
    private func getInfo() -> String? {
        ...
        if viewModel.hasMinimumRequiredBalance {
            return String.localizedStringWithFormat(NSLocalizedString("You have %@ BabaChain.\nSome usernames cost up to %@ BabaChain.", comment: "Usernames"), viewModel.balance, viewModel.recommendedBalance)
        }
        
        return String.localizedStringWithFormat(NSLocalizedString("You need to have more than %@ BabaChain to create a username", comment: "Usernames"), viewModel.minimumRequiredBalance)
    }
}
