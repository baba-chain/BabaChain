...
class InvitationBottomView: UIView {
    init(invitation: DSBlockchainInvitation) {
        ...
        containerView.backgroundColor = UIColor.dw_babachainBlue().withAlphaComponent(0.7)
        ...
        titleLable.text = invitation.identity.displayName ?? invitation.identity.currentBabaChainpayUsername
        ...
        if let dn = invitation.identity.displayName, !dn.isEmpty {
            ...
            sublabel.text = invitation.identity.currentBabaChainpayUsername
