...
- (void)viewDidLoad {
    ...
    title.textColor = [UIColor dw_babachainBlueColor];
    ...
    NSString *text = [NSString stringWithFormat:NSLocalizedString(@"You have been invited by %@. Start using BabaChain cryptocurrency.", nil), name];
