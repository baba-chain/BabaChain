...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        titleLabel.text = NSLocalizedString(@"How do I get Test BabaChain?", nil);
        ...
        descLabel.text = NSLocalizedString(@"Test BabaChain is free and can be obtained from what is called a faucet.\nCopy an address from the Receive screen of your wallet and click on the button bellow to get your BabaChain.", nil);
