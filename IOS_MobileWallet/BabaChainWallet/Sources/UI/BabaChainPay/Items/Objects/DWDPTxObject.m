...
- (NSAttributedString *)amountString {
    ...
    NSAttributedString *babachainAmountString = [self.dataProvider babachainAmountStringFrom:self.dataItem font:titleFont];
    ...
    [result beginEditing];
    [result appendAttributedString:babachainAmountString];
