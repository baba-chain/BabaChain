...
#import "DWDPBabaChainpayUserBackedItem.h"
...
- (id<DWDPBasicUserItem>)itemForEntity:(NSManagedObject *)entity {
    ...
    if ([entity isKindOfClass:DSBabaChainpayUserEntity.class]) {
        return [self itemForBabaChainpayUserEntity:(DSBabaChainpayUserEntity *)entity];
    }
...
- (id<DWDPBasicUserItem, DWDPBabaChainpayUserBackedItem>)itemForBabaChainpayUserEntity:(DSBabaChainpayUserEntity *)entity {
    return [[DWDPContactObject alloc] initWithBabaChainpayUserEntity:entity];
}
