...
- (NSPredicate *)predicate {
    DSBabaChainpayUserEntity *babachainPayUser = [self.blockchainIdentity matchingBabaChainpayUserInContext:self.context];
    return [NSPredicate predicateWithFormat:@"destinationContact == %@ || sourceContact == %@", babachainPayUser, babachainPayUser];
}
