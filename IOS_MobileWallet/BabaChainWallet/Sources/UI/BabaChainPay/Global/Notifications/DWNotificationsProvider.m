...
NSNotificationName const DWNotificationsProviderWillUpdateNotification = @"org.babachain.wallet.dp.notifications-will-update";
NSNotificationName const DWNotificationsProviderDidUpdateNotification = @"org.babachain.wallet.dp.notifications-did-update";
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(didUpdateContacts)
                                                     name:DWBabaChainPayContactsDidUpdateNotification
                                                   object:nil];
...
- (void)reload {
    ...
    DSBlockchainIdentity *blockchainIdentity = [DWEnvironment sharedInstance].currentWallet.defaultBlockchainIdentity;
    NSManagedObjectID *userID = blockchainIdentity.matchingBabaChainpayUserInViewContext.objectID;
