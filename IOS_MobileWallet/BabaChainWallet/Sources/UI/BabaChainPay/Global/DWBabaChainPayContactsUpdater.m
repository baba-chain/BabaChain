...
NSNotificationName const DWBabaChainPayContactsDidUpdateNotification = @"org.babachain.wallet.dp.contacts-did-update";

static NSTimeInterval const UPDATE_INTERVAL = 30;

@interface DWBabaChainPayContactsUpdater ()
...
@implementation DWBabaChainPayContactsUpdater

+ (instancetype)sharedInstance {
    static DWBabaChainPayContactsUpdater *_sharedInstance = nil;
...
- (void)fetchIntiatedInternally:(BOOL)initiatedInternally completion:(void (^_Nullable)(BOOL success, NSArray<NSError *> *errors))completion {
    ...
    [myBlockchainIdentity fetchContactRequests:^(BOOL success, NSArray<NSError *> *_Nonnull errors) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:DWBabaChainPayContactsDidUpdateNotification object:nil];
