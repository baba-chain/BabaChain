...
uint64_t DWDP_MIN_BALANCE_TO_CREATE_USERNAME = (DUFFS / 100) * 3; // 0.03 BabaChain
uint64_t DWDP_MIN_BALANCE_TO_CREATE_INVITE = (DUFFS / 100);       // 0.01 BabaChain
uint64_t DWDP_MIN_BALANCE_FOR_CONTESTED_USERNAME = (DUFFS / 4);   // 0.25 BabaChain
