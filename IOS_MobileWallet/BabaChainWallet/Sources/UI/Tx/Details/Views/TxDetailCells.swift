...
class TxDetailHeaderCell: UITableViewCell {
    ...
    @IBOutlet var babachainAmountLabel: UILabel!
    ...
    func updateView(with data: TxDetailHeaderCellDataProvider) {
        ...
        babachainAmountLabel.attributedText = data.babachainAmountString(with: font)
    ...
    override func awakeFromNib() {
        ...
        babachainAmountLabel.font = UIFont.dw_font(forTextStyle: .largeTitle).withWeight(UIFont.Weight.medium.rawValue)
        fiatAmountLabel.font = UIFont.dw_font(forTextStyle: .footnote)

        titleLabel.textColor = .dw_label()
        babachainAmountLabel.textColor = .dw_label()
    }
}
