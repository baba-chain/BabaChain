...
static UIColor *BackgroundColor(DWSeedPhraseType type) {
    switch (type) {
        ...
        case DWSeedPhraseType_Select:
            return [UIColor dw_babachainBlueColor];
    }
}
...
- (void)animateDiscardedSelectionWithCompletion:(void (^)(void))completion {
    ...
    redColorAnimation.fromValue = (id)[UIColor dw_babachainBlueColor].CGColor;
    ...
    blueColorAnimation.toValue = (id)[UIColor dw_babachainBlueColor].CGColor;
