...
extension IntegrationViewController {
    ...
    private func configureLogoutButton(isLoggedIn: Bool) {
        if isLoggedIn {
            ...
            signInOutButton.setTitleColor(UIColor(named: "BabaChainBlueColor"), for: .normal)
    ...
    private func configureHierarchy() {
        ...
        balanceView.babachainSymbolColor = .dw_babachainBlue()
...
extension IntegrationViewController: ASWebAuthenticationPresentationContextProviding {
    internal func initAuthentication(url: URL?) {
        ...
        let callbackURLScheme = "babachainwallet://".addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)
