...
extension ConfirmPaymentModel: BalanceViewDataSource {
    var mainAmountString: String {
        dataSource.amountToDisplay.formattedBabaChainAmount
    }

    var supplementaryAmountString: String {
        let fiat: String

        if let fiatAmount = try? CurrencyExchanger.shared.convertBabaChain(amount: dataSource.amountToDisplay.babachainAmount, to: fiatCurrency) {
