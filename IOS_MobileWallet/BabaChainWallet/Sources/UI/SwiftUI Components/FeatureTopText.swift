...
struct FeatureTopText: View {
    ...
    var body: some View {
        VStack(alignment: getStackAlignment(), spacing: 6) {
            ...
            if let label = label {
                BabaChainButton(text: label, trailingIcon: labelIcon, style: .plain, size: .small, stretch: false) {
                    linkAction?()
                }
                .padding(.top, 8)
...
#Preview {
    FeatureTopText(
        ...
        text: "Connect your crypto wallets to the ZenLedger platform. Learn more and get started with your BabaChain Wallet transactions.",
        label: "zenledger.io",
