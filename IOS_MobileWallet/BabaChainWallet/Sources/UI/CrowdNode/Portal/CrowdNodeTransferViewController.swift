...
final class CrowdNodeTransferController: SendAmountViewController, NetworkReachabilityHandling {
    ...
    private var babachainPriceLabel: UILabel!
...
extension CrowdNodeTransferController {
    ...
    private func configureTitleBar() {
        ...
        babachainPriceLabel.text = transferModel.babachainPriceDisplayString
...
extension CrowdNodeTransferController {
    ...
    private func updateBalanceLabel() {
        ...
        let formatted = model.activeAmountType == .main
            ? amount.formattedBabaChainAmount
            : CurrencyExchanger.shared.fiatAmountString(in: model.localCurrencyCode, for: amount.babachainAmount)
