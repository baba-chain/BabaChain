...
enum TransferDirection {
    ...
    var imageName: String {
        switch self {
        case .deposit: return "image.explore.babachain.wts.babachain"
    ...
    var direction: String {
        switch self {
        case .deposit: return NSLocalizedString("from BabaChain Wallet", comment: "from BabaChain Wallet")
    ...
    var keyboardHeader: String {
        ...
        case .withdraw: return NSLocalizedString("Sending to BabaChain Wallet on this device", comment: "CrowdNode")
        }
    }
    ...
    var keyboardHeaderIcon: String {
        ...
        case .withdraw: return "image.explore.babachain.wts.babachain"
        }
    }
...
final class CrowdNodeTransferModel: SendAmountModel {
    ...
    var babachainPriceDisplayString: String {
        ...
        let fiatBalanceFormatted = CurrencyExchanger.shared.fiatAmountString(in: localCurrencyCode, for: babachainAmount.babachainAmount)
