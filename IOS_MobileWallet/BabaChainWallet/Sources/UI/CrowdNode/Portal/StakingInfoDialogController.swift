...
final class StakingInfoDialogController: UIViewController {
    ...
    private func configureHierarchy() {
        ...
        subtitleLabel.text = NSLocalizedString("The BabaChain Network is driven by a number of Masternodes which are an essential part of facilitating payments.", comment: "CrowdNode")
        ...
        poolDescription.text = NSLocalizedString("As most people do not have exactly 1000 BabaChain at hand, Crowdnode has made a service where, by pooling deposits from members, they can achieve the benefits of owning a Masternode.", comment: "CrowdNode")
        ...
        apyDescription.text = NSLocalizedString("This represents the current Annual Percentage Yield of a full Masternode less the 15% CrowdNode fee. It is not a guaranteed rate of return and may go up or down based on the size of the CrowdNode pools and the BabaChain price.", comment: "CrowdNode")
        
        addressTitle.text = NSLocalizedString("Connected BabaChain address", comment: "CrowdNode")
        addressDescription.text = NSLocalizedString("Here is a BabaChain address designated for your CrowdNode account in the BabaChain Wallet on this device", comment: "CrowdNode")
        
        addressLabelTitle.text = NSLocalizedString("BabaChain address", comment: "")
        
        addressLabel.text = viewModel.accountAddress
        let minimumDeposit = CrowdNode.minimumDeposit.formattedBabaChainAmount
        ...
        masternodeApyLabel.text = String
            .localizedStringWithFormat(NSLocalizedString("A Masternode needs 1000 BabaChain as collateral and each Masternode is currently rewarded approximately %@ per year.",
                                                         comment: "CrowdNode"),
