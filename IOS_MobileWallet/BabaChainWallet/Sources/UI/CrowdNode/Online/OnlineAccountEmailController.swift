...
final class OnlineAccountEmailController: UIViewController {
    ...
    @IBOutlet var input: BabaChainInputField!
    ...
    private func configureHierarchy() {
        ...
        subtitleLabel.text = NSLocalizedString("Please note that the email is not saved by the BabaChain Wallet and is only sent to CrowdNode", comment: "CrowdNode")
