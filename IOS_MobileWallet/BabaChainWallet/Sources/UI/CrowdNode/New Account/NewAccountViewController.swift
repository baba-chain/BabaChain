...
extension NewAccountViewController {
    private func configureHierarchy() {
        ...
        addressTitleLabel.text = NSLocalizedString("BabaChain address", comment: "")
    ...
    private func configureForNewAccount() {
        ...
        explainerLabel2.text = NSLocalizedString("Very small amounts of BabaChain will be sent to and from CrowdNode to verify that you are the owner of this wallet address.", comment: "CrowdNode")
    }
    ...
    private func configureForLinkingOnlineAccount() {
        ...
        explainerLabel1.text = NSLocalizedString("All transfers to and from CrowdNode from this device will be performed with the below BabaChain address from this device.", comment: "CrowdNode")
