...
final class WelcomeToCrowdNodeViewController: BaseViewController {
    ...
    private func configureHierarchy() {
        ...
        titleLabel.text = NSLocalizedString("Become part of a BabaChain Masternode with CrowdNode", comment: "CrowdNode")
        stakingLabel.text = NSLocalizedString("Introducing Staking", comment: "CrowdNode")
        stakingSubtitleLabel.text = NSLocalizedString("Gain rewards from deposits in BabaChain Masternodes with as little as 0.5 BabaChain.", comment: "CrowdNode")
