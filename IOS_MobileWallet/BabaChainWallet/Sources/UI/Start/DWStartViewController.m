...
- (BOOL)upgradeOldKeys {
    ...
    if ([babachainSyncVersionManager noOldWallet]) {
        return NO;
    }

    DSWallet *wallet = [[DWEnvironment sharedInstance] currentWallet];
    [babachainSyncVersionManager upgradeVersion1ExtendedKeysForWallet:wallet
