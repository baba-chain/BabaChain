...
@property (strong, nonatomic) DWAmountInputValidator *babachainValidator;
...
- (void)setUp {
    ...
    self.babachainValidator = [[DWAmountInputValidator alloc] initWithType:DWAmountInputValidatorTypeBabaChain];
...
- (void)testMaximumLimits {
    for (NSLocale *locale in self.locales) {
        ...
        [self performBabaChainValidatorTests:testCases locale:locale];
    }
}
...
- (void)performBabaChainValidatorTests:(NSArray<DWAmountInputTestCase *> *)testCases locale:(NSLocale *)locale {
    for (DWAmountInputTestCase *test in testCases) {
        DWAmountInputValidator *validator = [[DWAmountInputValidator alloc] initWithType:DWAmountInputValidatorTypeBabaChain
                                                                                  locale:locale];
