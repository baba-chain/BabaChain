...
- (void)updateWithDisplayName:(NSString *)rawDisplayName
    ...
    if ([rawDisplayName isEqualToString:self.blockchainIdentity.currentBabaChainpayUsername]) {
        displayName = @"";
    }
    ...
    [self.blockchainIdentity updateBabaChainpayProfileWithDisplayName:displayName
