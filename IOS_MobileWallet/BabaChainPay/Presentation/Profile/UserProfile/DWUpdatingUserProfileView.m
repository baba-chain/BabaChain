...
@property (readonly, nonatomic, strong) DWBabaChainPayAnimationView *loadingView;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        DWBabaChainPayAnimationView *loadingView = [[DWBabaChainPayAnimationView alloc] init];
        ...
        titleLabel.text = NSLocalizedString(@"Updating Profile on BabaChain Network", nil);
