...
- (DWAvatarExternalSourceConfig *)config {
    ...
    config.desc = NSLocalizedString(@"Your Email is not stored in the BabaChainPay wallet nor on any servers. It is used once to get your Gravatar account details and then discarded.", nil);
