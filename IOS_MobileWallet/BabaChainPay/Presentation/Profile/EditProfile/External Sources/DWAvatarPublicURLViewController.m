...
- (DWAvatarExternalSourceConfig *)config {
    ...
    config.desc = NSLocalizedString(@"You can specify any URL which is publicly available on the internet so other users can see it on the BabaChain network.", nil);
