...
- (NSAttributedString *)attributedTitle {
    ...
    NSAttributedString *chooseYourString =
        [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Choose your", @"Choose your BabaChain username")
    ...
    NSAttributedString *babachainUsernameString =
        [[NSAttributedString alloc] initWithString:NSLocalizedString(@"BabaChain username", nil)
    ...
    [resultString appendAttributedString:babachainUsernameString];
