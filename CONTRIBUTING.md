...
Before you start contributing, familiarize yourself with the BabaChain Core build
system and tests. Refer to the documentation in the repository on how to build
BabaChain Core and how to run the unit and functional tests.
...
Most communication about BabaChain Core development happens on Discord Server.
...
include:
  ...
  - *qt* for changes to babachain-qt
...
fork of BabaChain Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the BabaChain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BabaChain
Network Protocol consensus changes.

Whether a pull request is merged into BabaChain Core rests with the project merge
maintainers.
...
Patches that change BabaChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the BabaChain consensus, it must have been
...
The review process is normally fairly responsive on the BabaChain Core repository, however
...
Bitcoin Backports are an incredibly valuable part of BabaChain's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for BabaChain](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
