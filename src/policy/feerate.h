...
const std::string CURRENCY_UNIT = "BABACHAIN"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BABACHAIN_KB,      //!< Use BABACHAIN/kB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BABACHAIN_KB) const;
