...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
        "\nReturns a new BabaChain address for receiving payments.\n"
        ...
        RPCResult{
    RPCResult::Type::STR, "address", "The new BabaChain address"
        },
        RPCExamples{
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{"getrawchangeaddress",
        "\nReturns a new BabaChain address, for receiving change.\n"
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{"setlabel",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The BabaChain address to be associated with a label."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::ARR, "", "",
                {
                    ...
                    {
                        {RPCResult::Type::STR, "address", "The BabaChain address"},
...
RPCHelpMan addmultisigaddress()
{
    return RPCHelpMan{"addmultisigaddress",
        ...
        "Each key is a BabaChain address or hex-encoded public key.\n"
        ...
        "Note: This command is only compatible with legacy wallets.\n",
        {
            ...
            {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "The BabaChain addresses or hex-encoded public keys",
                {
                    {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "BabaChain address or hex-encoded public key"},
                },
                },
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{"getaddressinfo",
        "\nReturn information about the given BabaChain address.\n"
        "Some of the information will only be present if the address is in the active wallet.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The BabaChain address for which to get information."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::STR, "address", "The BabaChain address validated."},
