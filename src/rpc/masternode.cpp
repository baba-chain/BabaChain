...
static RPCHelpMan masternodelist_helper(bool is_composite)
{
    ...
    return RPCHelpMan{is_composite ? "masternode list" : "masternodelist",
        ...
        "  owneraddress   - Print the masternode owner BabaChain address\n"
        "  payee          - Print the masternode payout BabaChain address (can be additionally filtered,\n"
        "                   partial match)\n"
        "  pubKeyOperator - Print the masternode operator public key\n"
        "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
        "                   (can be additionally filtered, partial match)\n"
        "  votingaddress  - Print the masternode voting BabaChain address\n",
        {
...
{
    static const CRPCCommand commands[]{
        {"babachain", &masternode_help},
        {"babachain", &masternodelist_composite},
        {"babachain", &masternodelist},
        {"babachain", &masternode_connect},
        {"babachain", &masternode_count},
        {"babachain", &masternode_status},
        {"babachain", &masternode_payments},
        {"babachain", &masternode_winners},
    };
