// Copyright (c) 2021-2025 The BabaChain Core developers
...
// See https://github.com/babachainpay/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
static constexpr std::array<LLMQParams, 14> available_llmqs = {
    ...
    /**
     * llmq_test (BabaChain Core 0.17) aka llmq_test_v17
     * This quorum is only used for testing
     *
     */
    LLMQParams{
