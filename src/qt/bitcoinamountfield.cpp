...
{
    Q_OBJECT
    BitcoinUnit currentUnit{BitcoinUnit::BABACHAIN};
...
public:
    ...
    QSize minimumSizeHint() const override
    {
        ...
        int h = 0;
        int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnit::BABACHAIN, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
        w += 2; // cursor blinking space
        w += GUIUtil::babachainThemeActive() ? 24 : 0; // counteract padding from css
        return QSize(w, h);
    }
