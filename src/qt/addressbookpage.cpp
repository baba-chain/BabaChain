...
// Copyright (c) 2014-2022 The BabaChain Core developers
    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your BabaChain addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        ui->newAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your BabaChain addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses."));
...
void AddressBookPage::on_showAddressQRCode_clicked()
{
    ...
    dialog->setInfo(tr("QR code"), "babachain:"+strAddress, "", strAddress);
    dialog->show();
}
