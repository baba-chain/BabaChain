    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage: babachain-qt [command-line options] [URI]\n\n"
                         "Optional URI is a BabaChain address in BIP21 URI format.\n";
...
All the BabaChain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BABACHAIN, 0.01 BABACHAIN, 0.1 BABACHAIN, 1 BABACHAIN and 10 BABACHAIN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.babachain.org/en/stable/wallets/babachaincore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
