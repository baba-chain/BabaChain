...
"""Script for verifying BabaChain Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
github.com and babachaincore-binaries.thepasta.org and compares them.
...
WORKINGDIR = "/tmp/babachain_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1="https://github.com/babachainpay/babachain/releases/download/v"
HOST2="https://babachaincore-binaries.thepasta.org/file/babachaincore-binaries/"
VERSIONPREFIX=""
...
def main(args):
    ...
    if not success:
        print("github.com failed to provide signature file, "
              "but babachaincore-binaries.thepasta.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("github.com and babachaincore-binaries.thepasta.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the BabaChain Core binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the BabaChain Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
