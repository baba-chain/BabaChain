...
When complete, it will have produced `BabaChain-Core.zip`.
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/babachainpay/babachain-detached-sigs).
