...
(
    ...
    sed -i.old 's/-lstdc++ //g' {./,src/babachainbls/,src/secp256k1/}{config.status,libtool}


    # Build BabaChain Core
    ...
    # Setup the directory where our BabaChain Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built BabaChain Core to $INSTALLPATH
    ...
    (
        ...
        # copy over the example babachain.conf file. if contrib/devtools/gen-babachain-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/contrib/debian/examples/babachain.conf" "${DISTNAME}/"
