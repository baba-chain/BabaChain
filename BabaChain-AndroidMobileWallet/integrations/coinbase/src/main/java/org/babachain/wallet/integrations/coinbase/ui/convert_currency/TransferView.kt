...
import org.babachain.wallet.integrations.coinbase.databinding.ConvertViewBinding
    ...
    private fun updateSymbols(isOnline: Boolean) {
        if (walletToCoinbase){
            ...
            ContextCompat.getDrawable(context,
                if (isOnline)
                R.drawable.ic_dash_blue_filled else org.babachain.wallet.common.R.drawable.ic_dash_saturated)
            ...
            ContextCompat.getDrawable(context, if (isOnline)
                ...
                ?.let { binding.convertFromBtn.setConvertItemIcon(it) }
            ContextCompat.getDrawable(context,
                if (isOnline) R.drawable.ic_dash_blue_filled else org.babachain.wallet.common.R.drawable.ic_dash_saturated)
                ?.let { binding.convertToBtn.setConvertItemIcon(it) }
        }
    }
