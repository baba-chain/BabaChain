 ...
 */
package org.babachain.wallet.integrations.coinbase.ui
...
import org.babachain.wallet.common.services.ConfirmTransactionService
...
import org.babachain.wallet.common.ui.*
...
import org.babachain.wallet.integrations.coinbase.CoinbaseConstants
import org.babachain.wallet.integrations.coinbase.R
import org.babachain.wallet.integrations.coinbase.databinding.TransferDashFragmentBinding
import org.babachain.wallet.integrations.coinbase.ui.convert_currency.model.BaseServiceWallet
import org.babachain.wallet.integrations.coinbase.ui.convert_currency.model.SwapValueErrorType
import org.babachain.wallet.integrations.coinbase.ui.dialogs.CoinBaseResultDialog
import org.babachain.wallet.integrations.coinbase.viewmodels.CoinbaseViewModel
import org.babachain.wallet.integrations.coinbase.viewmodels.EnterAmountToTransferViewModel
import org.babachain.wallet.integrations.coinbase.viewmodels.SendDashResponseState
import org.babachain.wallet.integrations.coinbase.viewmodels.TransferDashViewModel
import org.babachain.wallet.integrations.coinbase.viewmodels.coinbaseViewModels
...
class TransferDashFragment : Fragment(R.layout.transfer_dash_fragment) {
    ...
    private val enterAmountToTransferViewModel by coinbaseViewModels<EnterAmountToTransferViewModel>()
    private val transferDashViewModel by coinbaseViewModels<TransferDashViewModel>()
