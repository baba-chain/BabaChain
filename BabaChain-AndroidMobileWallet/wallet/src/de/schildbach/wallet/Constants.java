...
public final class Constants {
    ...
    static {
        ...
        switch (BuildConfig.FLAVOR) {
            case "prod": {
                ...
                org.babachain.wallet.common.util.Constants.INSTANCE.setEXPLORE_GC_FILE_PATH("explore/explore-v4.db");
                ...
                org.babachain.wallet.common.util.Constants.FAUCET_URL = "";
                break;
            }
            case "staging":
            case "_testNet3": {
                ...
                org.babachain.wallet.common.util.Constants.FAUCET_URL = "http://faucet.testnet.networks.dash.org/";
                org.babachain.wallet.common.util.Constants.INSTANCE.setEXPLORE_GC_FILE_PATH("explore/explore-v4-testnet.db");
                break;
            }
            case "devnet": {
                BIP44_PATH = DeterministicKeyChain.BIP44_ACCOUNT_ZERO_PATH_TESTNET;
                ...
                SYNC_FLAGS.add(MasternodeSync.SYNC_FLAGS.SYNC_HEADERS_MN_LIST_FIRST);
                SYNC_FLAGS.add(MasternodeSync.SYNC_FLAGS.SYNC_BLOCKS_AFTER_PREPROCESSING);
                org.babachain.wallet.common.util.Constants.FAUCET_URL = String.format("http://faucet.%s.networks.dash.org/", devNetName);
                org.babachain.wallet.common.util.Constants.INSTANCE.setEXPLORE_GC_FILE_PATH("explore/explore-v3-devnet.db");
                break;
            }
            default: {
        ...
        org.babachain.wallet.common.util.Constants.INSTANCE.setMAX_MONEY(NETWORK_PARAMETERS.getMaxMoney());
        org.babachain.wallet.common.util.Constants.INSTANCE.setBUILD_FLAVOR(BuildConfig.FLAVOR);
    }
    ...
    public interface Invitation {
        ...
        String IOS_APP_BUNDLEID = "org.babachainfoundation.dashpaytnt";
