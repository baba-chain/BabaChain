...
import org.babachain.wallet.common.ui.WebViewFragmentDirections
...
import org.babachain.wallet.integrations.crowdnode.ui.NavigationRequest
    ...
    private fun handleCrowdNodeError(error: Exception?) {
        if (error is CrowdNodeException && error.message == CrowdNodeException.MISSING_PRIMARY) {
            AdaptiveDialog.create(
                R.drawable.ic_error,
                getString(org.babachain.wallet.common.R.string.error),
