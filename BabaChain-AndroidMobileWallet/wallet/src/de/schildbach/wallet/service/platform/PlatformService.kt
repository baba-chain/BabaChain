...
import org.babachainj.platform.dapiclient.DapiClient
import org.babachainj.platform.dashpay.ContactRequests
import org.babachainj.platform.dashpay.Profiles
import org.babachainj.platform.dpp.DashPlatformProtocol
import org.babachainj.platform.dpp.toHex
import org.babachainj.platform.sdk.callbacks.ContextProvider
import org.babachainj.platform.sdk.platform.Identities
import org.babachainj.platform.sdk.platform.Names
import org.babachainj.platform.sdk.platform.Platform
import org.babachainj.platform.sdk.platform.PlatformStateRepository
...
class PlatformServiceImplementation @Inject constructor(
    ...
    init {
        val contextProvider = object : ContextProvider() {
            ...
            override fun getDataContract(identifier: org.babachainj.platform.sdk.Identifier?): ByteArray {
