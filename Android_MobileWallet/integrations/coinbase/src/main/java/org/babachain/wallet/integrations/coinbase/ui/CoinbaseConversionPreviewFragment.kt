...
import org.babachain.wallet.common.customtabs.CustomTabActivityHelper
...
import org.babachain.wallet.integrations.coinbase.databinding.FragmentCoinbaseConversionPreviewBinding
...
import org.babachain.wallet.integrations.coinbase.viewmodels.CoinbaseConversionPreviewViewModel
    ...
    private val countDownTimer by lazy {
        object : CountDownTimer(10000, 1000) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                setConfirmBtnStyle(org.babachain.wallet.common.R.style.PrimaryButtonTheme_Large_Blue, org.babachain.wallet.common.R.color.dash_white)
            }
    ...
    private fun SwapTradeUIModel.updateConversionPreviewUI() {
        ...
        binding.contentOrderReview.inputAccountIcon
            .load(GenericUtils.getCoinIcon(this.inputCurrency.lowercase())) {
                crossfade(true)
                scale(Scale.FILL)
                placeholder(org.babachain.wallet.common.R.drawable.ic_default_flag)
