...
* [BIP-21](https://github.com/bitcoin/bips/blob/master/bip-0021.mediawiki): URI scheme for making BabaChain payments
...
[BIP-72](https://github.com/bitcoin/bips/blob/master/bip-0072.mediawiki): `babachain:` URI extensions for payment protocol

The spec is supported, except the _"...it should ignore the babachain address/amount/label/message in
