...
import org.babachain.wallet.common.Configuration
import org.babachain.wallet.common.services.analytics.AnalyticsConstants
import org.babachain.wallet.common.services.analytics.AnalyticsService
import org.babachain.wallet.common.services.analytics.AnalyticsTimer
import org.babachainj.platform.dapiclient.model.GrpcExceptionInfo
import org.babachainj.platform.dashpay.BlockchainIdentity
import org.babachainj.platform.dashpay.UsernameInfo
import org.babachainj.platform.dashpay.UsernameRequestStatus
import org.babachainj.platform.dashpay.UsernameStatus
import org.babachainj.platform.dashpay.callback.WalletSignerCallback
import org.babachainj.platform.dpp.errors.ConcensusErrorMetadata
import org.babachainj.platform.dpp.errors.concensus.ConcensusException
import org.babachainj.platform.dpp.errors.concensus.basic.identity.IdentityAssetLockTransactionOutPointAlreadyExistsException
import org.babachainj.platform.dpp.errors.concensus.basic.identity.InvalidInstantAssetLockProofSignatureException
import org.babachainj.platform.dpp.identity.Identity
import org.babachainj.platform.sdk.platform.DomainDocument
import org.babachainj.platform.sdk.platform.Names
import org.babachainj.platform.wallet.IdentityVerify
...
class CreateIdentityService : LifecycleService() {
    companion object {
        ...
        private const val ACTION_CREATE_IDENTITY = "org.babachain.dashpay.action.CREATE_IDENTITY"
        private const val ACTION_CREATE_IDENTITY_FROM_INVITATION = "org.babachain.dashpay.action.CREATE_IDENTITY_FROM_INVITATION"

        private const val ACTION_RETRY_WITH_NEW_USERNAME = "org.babachain.dashpay.action.ACTION_RETRY_WITH_NEW_USERNAME"
        private const val ACTION_RETRY_AFTER_INTERRUPTION = "org.babachain.dashpay.action.ACTION_RETRY_AFTER_INTERRUPTION"

        private const val ACTION_RETRY_INVITE_WITH_NEW_USERNAME = "org.babachain.dashpay.action.ACTION_RETRY_INVITE_WITH_NEW_USERNAME"
        private const val ACTION_RETRY_INVITE_AFTER_INTERRUPTION = "org.babachain.dashpay.action.ACTION_RETRY_INVITE_AFTER_INTERRUPTION"

        private const val EXTRA_USERNAME = "org.babachain.dashpay.extra.USERNAME"
        private const val EXTRA_START_FOREGROUND_PROMISED = "org.babachain.dashpay.extra.EXTRA_START_FOREGROUND_PROMISED"
        private const val EXTRA_IDENTITY = "org.babachain.dashpay.extra.IDENTITY"
        private const val EXTRA_INVITE = "org.babachain.dashpay.extra.INVITE"
