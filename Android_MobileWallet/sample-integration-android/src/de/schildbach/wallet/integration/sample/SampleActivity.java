...
public class SampleActivity extends Activity {
    ...
    private static final String[] DONATION_ADDRESSES_MAINNET = {
            "XmCwQUBbu9oHnqR7w7L8C1tiTRXCQZgWo1",  //Hash Engineering donation BABACHAIN address
            "XmCwQUBbu9oHnqR7w7L8C1tiTRXCQZgWo1"
    };
    private static final String[] DONATION_ADDRESSES_TESTNET = {
            "yP8A3cbdxRtLRduy5mXDsBnJtMzHWs6ZXr",   // https://testnet-faucet.babachain.org/
            "yP8A3cbdxRtLRduy5mXDsBnJtMzHWs6ZXr"    // https://testnet-faucet.babachain.org/
    };
    private static final String MEMO = "Sample donation";
    private static final String WALLET_URI_SCHEME = "babachainwallet";
    ...
    private void sendInterAppCommunicationRequest(Uri requestUri, int requestCode) {
        ...
        if (componentName != null) {
            ...
            Toast.makeText(this, "BabaChain Wallet not installed", Toast.LENGTH_LONG).show();
        }
    }
